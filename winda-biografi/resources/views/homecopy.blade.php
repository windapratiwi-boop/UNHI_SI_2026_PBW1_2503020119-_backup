  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <div class="content">
        ...
        <p>Selamat datang di website Winda Pratiwi</p>
      </div>
    </div>
    ...
    <div class="carousel-item">
      <div class="content">
        <h1>HALO SEMUA</h1>
        <p>Saya sedang belajar membuat website sederhana</p>
      </div>
    </div>
...
<div class="container section">
  <div class="row g-4">
    ...
    <div class="col-md-4">
      ...
      <h4 class="mt-3">Memasak</h4>
      <p>Saya senang mencoba berbagai resep makanan.</p>
    </div>
    ...
    <div class="col-md-4">
      ...
      <h4 class="mt-3">Bernyanyi</h4>
      <p>Bernyanyi sebagai hiburan dan ekspresi diri.</p>
    </div>
...
<div class="about" id="tentang">
  <h3>Tentang Saya</h3>
  <p>Saya adalah seorang Mahasiswa yang sedang belajar membuat website dan mengembangkan kemampuan di bidang teknologi.</p>
</div>
